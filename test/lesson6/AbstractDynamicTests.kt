...
Наследник всех своих родных.
        ...
        assertEquals("кланк", longestCommonSubSequence("коллекция танков", "классный пряник"))
        assertEquals("хочет", longestCommonSubSequence("хороший счетчик", "эх, очень круто"))
        assertEquals("пять", longestCommonSubSequence("плясать? давай.", "пряник и нить"))
    }
    ...
    fun longestIncreasingSubSequence(longestIncreasingSubSequence: (List<Int>) -> List<Int>) {
        ...
        assertEquals(listOf(5, 11), longestIncreasingSubSequence(listOf(5, 11, 0, 6)))
        assertEquals(listOf(11), longestIncreasingSubSequence(listOf(11, 11, 0, 0)))
    }
    ...
    fun shortestPathOnField(shortestPathOnField: (String) -> Int) {
        ...
        assertEquals(30, shortestPathOnField("input/field_in7.txt"))
    }
